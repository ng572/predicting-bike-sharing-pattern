...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fb3abe90be0>
...
```
    ...
    Progress: 0.3% ... Training loss: 0.698 ... Validation loss: 1.156
...
The neural network failed to predict the data after 21 Dec.

This may be because the temperature is too extreme in the winter, and the algorithm is too sensitive to heat change. (most of the training data have mild temperature change so overfitted sensitivity may be high on temp).
